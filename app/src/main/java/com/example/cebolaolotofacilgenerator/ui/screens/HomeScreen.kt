...
import com.example.cebolaolotofacilgenerator.Routes
    ...
    Scaffold(
        ...
        Column(
            ...
            HomeCard(
                    ...
                    description = "Confira os números sorteados em concursos anteriores",
                    onClick = { navController.navigate(Routes.Resultados.route) },
